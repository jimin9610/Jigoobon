...
String sql = "insert into "+code+" (id,name,gongji,title,comment,wrdate,file1,file1_o,nickname) values ('"+se_id+"','"+se_name+"','"+go+"','"+su+"','"+co+"','"+wrdate+"','"+file1_rename+"','"+file1_name+"','"+ni+"')";
