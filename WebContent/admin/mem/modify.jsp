...
<form name="modify_update.jsp" action="/admin/mem/modify_update.jsp" method="post" onsubmit="return modify()">
...
<table width=500px border=0 align=center>
	...
	<tr>
		<td colspan=2 width=340 height=30 style="background-color: white;border: 0.5px solid #dadada;">
			<input id="meid" name="meid" value="<%=meid %>" style="width: 98%;height:30px;border: 0px;font-size: 17px">
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan=2 height=30 style="background-color: white;border: 0.5px solid #dadada">
			<table>
				<tr>
					<td width=315 ><input id="mepass" name="mepass" value="" style="width: 98%;height:30px;border: 0px;font-size: 17px" type="password"></td>
	...
	<tr>
		<td colspan=2 height=30 style="background-color: white;border: 0.5px solid #dadada">
			<table>
				<tr>
					<td width=315 ><input id="mepass2" name="mepass2" value="" style="width: 98%;height:30px;border: 0px;font-size: 17px" type="password"></td>
	...
	<tr>
		<td colspan=2 height=30 style="background-color: white;border: 0.5px solid #dadada">
			<table>
				<tr>
					<td width=315 ><input id="mename" name="mename" value="<%=name%>" placeholder="가입 후 변경할 수 없습니다." style="width: 98%;height:30px;border: 0px;font-size: 20px" ></td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
		<td colspan=2 height=30 style="background-color: white;border: 0.5px solid #dadada">
			<table>
				<tr>
					<td width=340 ><input id="menina" name="menina" value="<%=nina%>" placeholder="7자까지 입력 가능합니다." style="width: 98%;height:30px;border: 0px;font-size: 17px"></td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
		<td colspan=2 height=30 style="background-color: white;border: 0.5px solid #dadada">
			<table>
				<tr>
					<td width=315 ><input id="mephone" name="mephone" value="<%=phone %>" placeholder="'-'를 포함하여 입력하세요." style="width: 98%;height:30px;border: 0px;font-size: 20px" ></td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
		<td colspan=2 style="width:450px;border: 0.5px solid #dadada">
			<input id="meemail1" name="meemail1" value="<%=email1 %>" style="width:200px;height:40px;border:0px;font-size: 20px">@<input id="meemail2" name="meemail2" value="<%=email2 %>" style="width:200px;height:40px;border: 0px;font-size: 20px">
		</td>
	</tr>
	...
	<tr>
		...
		<td style="background-color: white"><input id="melv" name="melv" value="<%=lv%>" style="width:50px;height:20px;border:0px;font-size: 15px;border: 0.5px solid #dadada" ></td>
	</tr>
	<tr><td colspan=2 height=10></td></tr>	
	<tr>
		<td colspan="2" height=30 align=right><button id="button1" style="cursor: pointer;">회원수정</button></td>
	</tr>
