...
if(pass.equals("")){
	sql = "update member set phone='"+phone+"',email1='"+email1+"',email2='"+email2+"',zipcode='"+zipcode+"',zipcode1='"+zipcode1+"',zipcode2='"+zipcode2+"',zipcode3='"+zipcode3+"',zipcode4='"+zipcode4+"',gender='"+gender+"',level='"+level+"',nickname='"+nina+"' where id='"+id+"'";
}else{
	sql = "update member set pass='"+pass+"',phone='"+phone+"',email1='"+email1+"',email2='"+email2+"',zipcode='"+zipcode+"',zipcode1='"+zipcode1+"',zipcode2='"+zipcode2+"',zipcode3='"+zipcode3+"',zipcode4='"+zipcode4+"',gender='"+gender+"',level='"+level+"',nickname='"+nina+"'  where id='"+id+"'";
}
