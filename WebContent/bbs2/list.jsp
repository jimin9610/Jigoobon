				...
				<%if(i%3 == 1){%><tr><%}%>				
					<td style="text-align:center" width=33%>
						...
						<a href="view.jsp?code=<%=code%>&uid=<%=uid%>&field=<%=field%>&search=<%=search%>">
							<img vertical-align=middle align=center src="/upload/<%=file1%>" width=250 height=250><br><br><font size=3px face="Myeongjo"><%=nick%></font>
							<%//2일전까지 최신글 처리
...
<table width=700 border=0 align=center>
	...
	<tr>
		<td colspan=2 align=center height=30px style="background-color:#ecf8fd;border-radius: 15px;">	
<%
/////////////////////
//페이징 처리
