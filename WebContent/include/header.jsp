		...
		<td>
			<table width=200px align=right style="padding-bottom:10px;font-size: 15px;border-radius:10px;background-color:#e1f7ff;text-align:right">
				...
				<tr>
					...
					%>
					<button onclick="location.href='/admin';" style="height:25px;border: 1px solid white;border-radius:6px;background-color: #ff7d9e;color:white;cursor: pointer;"><font size=1px>관리자</font></button>
					</td>
				</tr>
				<%} %>
			</table>
